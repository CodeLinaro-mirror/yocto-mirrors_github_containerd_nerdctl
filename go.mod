...
require (
	...
	github.com/compose-spec/compose-go/v2 v2.14.0 //gomodjail:unconfined
	...
	github.com/containerd/containerd/v2 v2.3.3 //gomodjail:unconfined
	...
	github.com/docker/cli v29.7.2+incompatible //gomodjail:unconfined
	...
	github.com/rootless-containers/rootlesskit/v3 v3.0.2 //gomodjail:unconfined
